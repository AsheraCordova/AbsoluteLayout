...
import {AbsoluteLayout} from './web/widget/AbsoluteLayoutImpl';
import * as targetSuperClassView from './android/widget/ViewImpl';
import {AbsoluteLayout_LayoutParams} from './web/widget/AbsoluteLayoutImpl';

import * as targetView from './web/widget/AbsoluteLayoutImpl';
import {Gravity} from './widget/TypeConstants';
import {View} from './web/widget/ViewImpl';
